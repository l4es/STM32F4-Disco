...
//Debugging macros
   ...
   #define TRACE_FATAL(...) osTaskSuspendAll(), usart_printf( __VA_ARGS__), osTaskResumeAll()
#else
   #define TRACE_FATAL(...)
#endif

#if (TRACE_LEVEL >= TRACE_LEVEL_ERROR)
   #define TRACE_ERROR(...) osTaskSuspendAll(), usart_printf( __VA_ARGS__), osTaskResumeAll()
#else
   #define TRACE_ERROR(...)
#endif

#if (TRACE_LEVEL >= TRACE_LEVEL_WARNING)
   #define TRACE_WARNING(...) osTaskSuspendAll(), usart_printf( __VA_ARGS__), osTaskResumeAll()
#else
   #define TRACE_WARNING(...)
#endif

#if (TRACE_LEVEL >= TRACE_LEVEL_INFO)
   #define TRACE_INFO(...) osTaskSuspendAll(), usart_printf( __VA_ARGS__), osTaskResumeAll()
   ...
   #define TRACE_DEBUG(...) osTaskSuspendAll(), usart_printf( __VA_ARGS__), osTaskResumeAll()
