...
//Base64 encoding support
   ...
   #error BASE64_SUPPORT parameter is invalid
#endif
...
//MD2 hash support
   ...
   #error MD2_SUPPORT parameter is invalid
#endif
...
//MD4 hash support
   ...
   #error MD4_SUPPORT parameter is invalid
#endif
...
//MD5 hash support
   ...
   #error MD5_SUPPORT parameter is invalid
#endif
...
//RIPEMD-128 hash support
   ...
   #error RIPEMD128_SUPPORT parameter is invalid
#endif
...
//RIPEMD-160 hash support
   ...
   #error RIPEMD160_SUPPORT parameter is invalid
#endif
...
//SHA-1 hash support
   ...
   #error SHA1_SUPPORT parameter is invalid
#endif
...
//SHA-224 hash support
   ...
   #error SHA224_SUPPORT parameter is invalid
#endif
...
//SHA-256 hash support
   ...
   #error SHA256_SUPPORT parameter is invalid
#endif
...
//SHA-384 hash support
   ...
   #error SHA384_SUPPORT parameter is invalid
#endif
...
//SHA-512 hash support
   ...
   #error SHA512_SUPPORT parameter is invalid
#endif
...
//SHA-512/224 hash support
   ...
   #error SHA512_224_SUPPORT parameter is invalid
#endif
...
//SHA-512/256 hash support
   ...
   #error SHA512_256_SUPPORT parameter is invalid
#endif
...
//Whirlpool hash support
   ...
   #error WHIRLPOOL_SUPPORT parameter is invalid
#endif
...
//HMAC support
   ...
   #error HMAC_SUPPORT parameter is invalid
#endif
...
//RC4 support
   ...
   #error RC4_SUPPORT parameter is invalid
#endif
...
//RC6 support
   ...
   #error RC6_SUPPORT parameter is invalid
#endif
...
//IDEA support
   ...
   #error IDEA_SUPPORT parameter is invalid
#endif
...
//DES support
   ...
   #error DES_SUPPORT parameter is invalid
#endif
...
//Triple DES support
   ...
   #error DES3_SUPPORT parameter is invalid
#endif
...
//AES support
   ...
   #error AES_SUPPORT parameter is invalid
#endif
...
//Camellia support
   ...
   #error CAMELLIA_SUPPORT parameter is invalid
#endif
...
//SEED support
   ...
   #error SEED_SUPPORT parameter is invalid
#endif
...
//ARIA support
   ...
   #error ARIA_SUPPORT parameter is invalid
#endif
...
//ECB mode support
   ...
   #error ECB_SUPPORT parameter is invalid
#endif
...
//CBC mode support
   ...
   #error CBC_SUPPORT parameter is invalid
#endif
...
//CFB mode support
   ...
   #error CFB_SUPPORT parameter is invalid
#endif
...
//OFB mode support
   ...
   #error OFB_SUPPORT parameter is invalid
#endif
...
//CTR mode support
   ...
   #error CTR_SUPPORT parameter is invalid
#endif
...
//CCM mode support
   ...
   #error CCM_SUPPORT parameter is invalid
#endif
...
//GCM mode support
   ...
   #error GCM_SUPPORT parameter is invalid
#endif
