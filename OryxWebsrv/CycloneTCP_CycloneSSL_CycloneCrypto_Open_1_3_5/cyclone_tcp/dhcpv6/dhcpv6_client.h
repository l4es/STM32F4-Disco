...
typedef struct
{
   ...
   time_t exchangeStartTime;               ///<Time at which the client sent the first message
   uint32_t rc;                            ///<Retransmission count
   uint32_t mrc;                           ///<Maximum retransmission count
   time_t rt;                              ///<Retransmission timeout
   time_t irt;                             ///<Initial retransmission timeout
   time_t mrt;                             ///<Maximum retransmission timeout
   time_t mrd;                             ///<Maximum retransmission duration
