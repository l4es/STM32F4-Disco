...
//PHY IRQ pin
#define AT91B_PHY_IRQ          AT91C_PIO_PB26
#define AT91D_BASE_PIO_PHY_IRQ AT91C_BASE_PIOB
#define AT91D_ID_PIO_PHY_IRQ   AT91C_ID_PIOB
...
#define KSZ8051_PHY_REG_RECR       0x15
...
#define KSZ8051_PHY_REG_LINKMDCSR  0x1D
...
//LINKMDCSR register
#define LINKMDCSR_CABLE_DIAG_EN     (1 << 15)
#define LINKMDCSR_CABLE_DIAG_RES1   (1 << 14)
#define LINKMDCSR_CABLE_DIAG_RES0   (1 << 13)
#define LINKMDCSR_SHORT_CABLE       (1 << 12)
#define LINKMDCSR_CABLE_FAULT_CNT8  (1 << 8)
#define LINKMDCSR_CABLE_FAULT_CNT7  (1 << 7)
#define LINKMDCSR_CABLE_FAULT_CNT6  (1 << 6)
#define LINKMDCSR_CABLE_FAULT_CNT5  (1 << 5)
#define LINKMDCSR_CABLE_FAULT_CNT4  (1 << 4)
#define LINKMDCSR_CABLE_FAULT_CNT3  (1 << 3)
#define LINKMDCSR_CABLE_FAULT_CNT2  (1 << 2)
#define LINKMDCSR_CABLE_FAULT_CNT1  (1 << 1)
#define LINKMDCSR_CABLE_FAULT_CNT0  (1 << 0)
...
#define PHYCON2_ENERGY_DETECT       (1 << 11)
...
void __irq ksz8051Interrupt(void);
