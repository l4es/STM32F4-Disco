...
//Enable FTP client support
   ...
   #error FTP_CLIENT_SUPPORT parameter is invalid
#endif
...
//Default timeout
   ...
   #error FTP_CLIENT_DEFAULT_TIMEOUT parameter is invalid
#endif
...
//Size of the buffer for input/output operations
   ...
   #error FTP_CLIENT_BUFFER_SIZE parameter is invalid
#endif
...
typedef struct
{
   ...
   IpAddr serverAddr;                     //IP address of the FTP server
