...
//ARP tick interval
   ...
   #error ARP_TICK_INTERVAL parameter is invalid
#endif
...
//Size of ARP cache
   ...
   #error ARP_CACHE_SIZE parameter is invalid
#endif
...
//Maximum number of packets waiting for address resolution to complete
   ...
   #error ARP_MAX_PENDING_PACKETS parameter is invalid
#endif
...
//Maximum number of times that an ARP request will be retransmitted
   ...
   #error ARP_MAX_REQUESTS parameter is invalid
#endif
...
//Time interval between subsequent retransmissions of ARP requests
   ...
   #error ARP_REQUEST_TIMEOUT parameter is invalid
#endif
...
//Maximum number of times that a probe will be retransmitted
   ...
   #error ARP_MAX_PROBES parameter is invalid
#endif
...
//time interval between subsequent retransmissions of probes
   ...
   #error ARP_PROBE_TIMEOUT parameter is invalid
#endif
...
//The time a host is considered reachable after receiving a reachability confirmation
   ...
   #error ARP_REACHABLE_TIME parameter is invalid
#endif
...
//Delay before sending the first probe
   ...
   #error ARP_DELAY_FIRST_PROBE_TIME parameter is invalid
#endif
...
typedef struct
{
   ...
   time_t timestamp;                            //Time stamp to manage entry lifetime
