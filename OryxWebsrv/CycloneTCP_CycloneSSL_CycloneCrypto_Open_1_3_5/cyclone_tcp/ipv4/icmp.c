   ...
   Ipv4Addr srcIpAddr, const ChunkedBuffer *buffer, size_t offset)
{
   ...
   //Debug message
   TRACE_INFO("ICMP message received (%u bytes)...\r\n", length);
   ...
   Ipv4Addr srcIpAddr, const ChunkedBuffer *request, size_t requestOffset)
{
   ...
   //Debug message
   TRACE_INFO("ICMP Echo Request message received (%u bytes)...\r\n", requestLength);
   //Dump message contents for debugging purpose
   ...
   //Debug message
   TRACE_INFO("Sending ICMP Echo Reply message (%u bytes)...\r\n", replyLength);
   //Dump message contents for debugging purpose
   ...
   uint8_t code, uint8_t parameter, const ChunkedBuffer *ipPacket)
{
   ...
   //Debug message
   TRACE_INFO("Sending ICMP Error message (%u bytes)...\r\n", length);
   //Dump message contents for debugging purpose
