...
//IGMP support
   ...
   #error IGMP_SUPPORT parameter is invalid
#endif
...
//IGMP tick interval
   ...
   #error IGMP_TICK_INTERVAL parameter is invalid
#endif
...
//Unsolicited report interval
   ...
   #error IGMP_UNSOLICITED_REPORT_INTERVAL parameter is invalid
#endif
...
//Maximum response time for IGMPv1 queries
   ...
   #error IGMP_V1_MAX_RESPONSE_TIME parameter is invalid
#endif
...
//Older version querier present timeout
   ...
   #error IGMP_V1_ROUTER_PRESENT_TIMEOUT parameter is invalid
#endif
