...
//IPv4 support
   ...
   #error IPV4_SUPPORT parameter is invalid
#endif
...
//Default IPv4 time-to-live value
   ...
   #error IPV4_DEFAULT_TTL parameter is invalid
#endif
...
//Maximum number of DNS servers
   ...
   #error IPV4_MAX_DNS_SERVERS parameter is invalid
#endif
...
//Maximum size of the IPv4 filter table
   ...
   #error IPV4_FILTER_MAX_SIZE parameter is invalid
#endif
